...
- [x] P1.9 — Lighthouse 95+ auf Public-Landing, Login und Backoffice-Dashboard: Code-Massnahmen und Baseline-Messung abgeschlossen (#51); Messung gegen Production (hege.app) durchgefuehrt und in [docs/lighthouse-baseline-2026-05-08.md](docs/lighthouse-baseline-2026-05-08.md) dokumentiert.
