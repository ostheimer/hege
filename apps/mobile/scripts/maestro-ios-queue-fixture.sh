...
fixture="$(jq -cn '[{
  id: "fallwild-maestro-conflict",
  kind: "fallwild-create",
  title: "Fuchs / Gänserndorf",
  createdAt: "2026-07-12T17:30:00.000Z",
  status: "conflict",
  attemptCount: 1,
  lastAttemptAt: "2026-07-12T17:31:00.000Z",
  lastError: "Kontrollierter Simulator-Konflikt",
  payload: {
    recordedAt: "2026-07-12T17:30:00.000Z",
    location: {lat: 48.3394, lng: 16.7202, label: "Gänserndorf"},
    wildart: "Fuchs",
    geschlecht: "weiblich",
    altersklasse: "Adult",
    bergungsStatus: "geborgen",
    gemeinde: "Gänserndorf",
    note: "Maestro Queue UI"
  }
}]')"
tmp="$(mktemp)"
...
maestro test \
  -e "APP_ID=$app_id" \
  "$repo_root/.maestro/ios-offline-queue.yaml"
